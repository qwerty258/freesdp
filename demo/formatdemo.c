/*
  ...
  formatdemo is free software; you can redistribute it and/or modify
  it under the terms of the GNU General Public License as published by
  the Free Software Foundation; either version 2 of the License, or
  (at your option) any later version.

  formatdemo is distributed in the hope that it will be useful,
...
int main(int argc, char* argv[])
{
    ...
    fsdp_media_description_t* mdsc1 = NULL;
    fsdp_media_description_t* mdsc2 = NULL;
    char* text = NULL;
    fsdp_error_t result;
    ...
    /* Note that fsdp_make_description allocates a new description object in
       *dsc */
    fsdp_make_description(&dsc, 0, "A test session", "1000000000", "1111111111", "userfoo", FSDP_NETWORK_TYPE_INET, FSDP_ADDRESS_TYPE_IPV4, "127.0.0.1", time(NULL), time(NULL) + 36000);
    ...
    fsdp_set_conn_address(dsc, FSDP_NETWORK_TYPE_INET, FSDP_ADDRESS_TYPE_IPV4, "127.0.0.3", 0, 0);
    ...
    fsdp_set_media_conn_address(mdsc2, FSDP_NETWORK_TYPE_INET, FSDP_ADDRESS_TYPE_IPV4, "127.0.0.5", 0, 0);
    fsdp_set_media_sendrecv(mdsc2, FSDP_SENDRECV_SENDONLY);
    fsdp_set_media_encryption(mdsc2, FSDP_ENCRYPTION_METHOD_URI, "http://www.example.com/key");
