 ...
 **/
const char *
fsdp_get_media_formats(const fsdp_media_description_t *dsc);
 ...
 **/
const char *
fsdp_get_media_sdplang(const fsdp_media_description_t *dsc, 
		       unsigned int index);
 ...
 **/
unsigned int
fsdp_get_media_lang_count(const fsdp_media_description_t *dsc);

/**
 *
 **/
const char *
fsdp_get_media_lang(const fsdp_media_description_t *dsc, 
		    unsigned int index);
